...
func NewRegistry(internalToken string, customs []CustomProvider) *Registry {
        ...
        r.providers = append(r.providers,
                ...
                &Provider{ID: "freebuff", Kind: KindBridge, Label: "Freebuff (freebuff.com — FREE, Codebuff tier)", Enabled: true},
        )
...
func fallbackBridgeModels(id string) []string {
        ...
        case "freebuff":
                // verified free-tier catalog (unmetered first); refreshed live
                return []string{"z-ai/glm-5.3-flash", "deepseek/deepseek-v4.1-flash", "mimo/mimo-v2.5", "upstage/solar-mini4"}
        }
        return nil
}
...
func autoChainIDs(r *Registry) []string {
        ...
        preferred := []struct{ id, model string }{
                ...
                {"freebuff", "z-ai/glm-5.3-flash"},    // free unmetered, Cline-in-9router parity
        }
        var out []string
